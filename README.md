...
- 当前敌人 AI 是确定性的优先级规则状态机，不是行为树、规划器或学习型 AI。它已经包含视线、埋伏、最后目击点、巡逻、寻路、传送门、陷阱、高差、诱饵和若干敌人特性，但暂时没有“敌人协同、角色分工、集火、包抄、撤退、诱导玩家走位”等高层战术。
- 多敌人重构计划见 [.omc/plans/multi-enemy-refactor-plan.md](./.omc/plans/multi-enemy-refactor-plan.md)；战术 AI 不与本次多敌人基础接入混在一起，后续单独设计和验收。
