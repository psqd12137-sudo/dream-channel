...
static func for_room(room_type: String, _theme: String, props: Array) -> Dictionary:
	...
	return {
		...
		"camera_distance_ratio": clampf(0.92, 0.80, 1.25),
		"camera_fit_margin": clampf(1.04, 0.85, 1.25),
		"dof_focus_width": clampf(0.28, 0.02, 0.45),
		"dof_blur_strength": clampf(3.8, 0.0, 12.0),
