...
| [现实玩具、电视梦境与节目循环](./design/2026-09-10-现实玩具与电视梦境.md) | 现实拼装、梦境动机、电视节目、实体解锁与三阶段方向；展开主策划第 0.1 节 | 方向已确认，具体机制未决 |
| [未决设计](./open-questions.md) | 尚未拍板的问题与临时口径 | 持续维护 |
| [片场工房与角色类型](./design/2026-08-26-workshop-and-kits.md) | 2026-08-26 讨论：局外工房、开局掷套、尖塔 2 引擎、喵喵卡面 | 未决讨论 |
