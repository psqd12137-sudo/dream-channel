...
const KAYKIT_DOOR_SCALE := Vector3((CELL - KAYKIT_JUNCTION_WIDTH) / 2.0, KAYKIT_WALL_HEIGHT / 2.75, KAYKIT_JUNCTION_WIDTH / 0.773546)
...
func shell_geometry_is_grid_exact() -> bool:
	...
	var door_span := 2.0 * KAYKIT_DOOR_SCALE.x + KAYKIT_JUNCTION_WIDTH
